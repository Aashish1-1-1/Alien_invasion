...
class AleinInvasion:
    ...
    def _check_keydown_event(self,event):
        if (event.key == pygame.K_RIGHT or event.key == pygame.K_l):
            ...
            self._check_play_button((538, 415))
    ...
    def _fire_bullet(self):
        fire = pygame.mixer.Sound('./audio/shoot.wav')
        fire.set_volume(0.5)
    ...
    def _check_bullet_alien_collisions(self):
        ...
        collision_sound = pygame.mixer.Sound('./audio/ship_hit.wav')
    ...
    def _create_fleet(self):
        ...
        availabel_sapce_y = (self.settings.screen_height - (3*alien_height)-ship_height)
        number_rows = availabel_sapce_y//(2*alien_height)
